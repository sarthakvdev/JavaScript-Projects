...
6. Check if the answer is correct and print to the console whether the answer is correct ot nor (Hint: write another method for 
    this).
...
10. Track the user's score to make the game more fun! So each time an answer is correct, add 1 point to the score (Hint: I'm going 
    to use the power of closures for this, but you don't have to, just do this with the tools you feel more comfortable
    at this point).

11. Display the score in the console. Use yet another method for this.
*/

// Error: Its showing 'Wrong Answer' after displaying question and its options.
// Debug it
...
var Question = function(question, choices, correct) {
    ...
    this.checkAnswer = function(ans, keepScore) {
        var sc;
...
var q1 = new Question("Q. Is JavaScript World's one of the most important languages?", 
                        ["Yes", "No"], 
                        0);
var q2 = new Question("Q. Who is real Elliot Alderson?", 
                        ["Mr Robot", "Mastermind", "One in dream", 
                        "Doesn't exists"], 2);
var q3 = new Question("Q. Saina Nehwal is a player of which game?", 
                        ["Cricket", "Batminton", "Tennis", "None of the above"], 
                        1);
var q4 = new Question("Q. Why Walter White aka Heisenberg turned towards Meth Cooking Empire?", 
                        ["Family", "To prove himself", "Condemned to do it", "Himself"], 
                        3);
...
function nextQuestion() {
    var n = Math.round(Math.random() * (questions.length - 1)); //select a random number between 0-3
    questions[n].displayQuestion();                               //Select questions based on random number
